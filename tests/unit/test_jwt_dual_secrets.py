...
def test_an_overlapping_pair_of_rings_is_refused_at_configuration_time() -> None:
    ...
    with pytest.raises(ValueError, match="share NO key"):
        Settings(
            ...
            sso_encryption_key="real-sso-encryption-key-0123456789",
            notification_encryption_key="real-notification-key-0123456789",
            incoming_webhook_encryption_key="real-incoming-webhook-key-0123456789",
