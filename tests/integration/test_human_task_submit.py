...
async def _seed(dsn: str) -> dict[str, UUID]:
    ...
    try:
        ...
        # peer_human_reviewer so the submit path stays in_review (task_16_11):
        # this suite tests the task_16_09 work-session + in_review transition;
        # the auto_approve -> done behaviour is covered by test_human_review_auto.
        await conn.execute(
