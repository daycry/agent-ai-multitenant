...
[![ADRs](https://img.shields.io/badge/ADRs-168-0ea5e9.svg)](docs/05-architecture-decisions/README.md)
[![Migrations](https://img.shields.io/badge/migrations-149-0ea5e9.svg)](apps/api-server/migrations/versions)
...
| **Las decisiones están escritas**               | 168 ADR, una cadena de precedencia para cuando dos documentos se contradicen, y tests que fallan cuando la documentación deja de describir el repositorio                                                     |
...
forma incremental**. Es grande —168 ADR, un catálogo entero de gotchas, las siete
