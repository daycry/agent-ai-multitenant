...
| **Las decisiones están escritas**               | 167 ADR, una cadena de precedencia para cuando dos documentos se contradicen, y tests que fallan cuando la documentación deja de describir el repositorio                                                     |
...
forma incremental**. Es grande —167 ADR, un catálogo entero de gotchas, las siete
