...
| **Decisions are written down**        | 165 ADRs, a precedence chain for when two documents disagree, and tests that fail when the documentation stops describing the repository                                                               |
...
incrementally**. It is large — 165 ADRs, a full gotchas catalogue, seven
