...
| [bilingual-docs.md](./bilingual-docs.md) ([castellano](./bilingual-docs.es.md)) | Política de documentación bilingüe: inglés canónico, `foo.es.md` para el castellano, y la guarda que impide que un par se quede a medias |
