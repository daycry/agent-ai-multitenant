...
Esta carpeta explica **qué es la plataforma y por qué existe**: el
...
Cuando ya sepas qué es el sistema, pasa a
[02-getting-started](../02-getting-started/) para levantarlo en local.
