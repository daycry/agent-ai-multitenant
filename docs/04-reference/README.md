...
| [mapa-de-pantallas-del-panel.md](./mapa-de-pantallas-del-panel.md) | Las 81 rutas del panel con su **área** (Trabajo · Proyecto · Sistema · cabecera · sin sesión) y el rol que las ve en el menú. Comprobado contra el árbol en las dos direcciones. |
