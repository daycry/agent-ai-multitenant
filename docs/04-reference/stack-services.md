...
| `egress-proxy`     | `agentic-platform/egress-proxy:v1` (_build_ `./egress-proxy`) | tinyproxy con **allowlist**: única salida a internet del sandbox de agentes (ADR 0019).              | **8888**                            | http://localhost:8888 (proxy)                                              |
