...
40 planes están en `pending_human_validation`: **código mergeado en `master` sin sign-off humano**
(el número cuarenta es `remediacion-marketplace-mcp-2026-09-02`, que cerró sus quince casillas el
2026-09-09; su código vive en el PR #183, aún sin mergear).
