...
| [marketplace-v2-despliegue.md](./marketplace-v2-despliegue.md)                                             | Que instalar del marketplace sea RECIBIR: el despliegue en proyectos como entidad, publicación con revisión y versiones con re-consentimiento del delta (diseño aprobado 2026-07-31, ADR 0142).                                                                                                                                                                                                                                                                                                 |
...
| [remediacion-ciclo-vida-proyecto-2026-09-01.md](./remediacion-ciclo-vida-proyecto-2026-09-01.md)           | Ciclo de vida de un proyecto en 5 olas: fase de tests que vuelve a correr, política de aprobación efectiva, `EXEC=1` en el proxy, agentes core sin pin `anthropic`, reviewer que ve sólo lo suyo, reclamaciones con identidad, sandbox sin spec en el env.                                                                                                                                                                                                                                      |
| [remediacion-marketplace-mcp-2026-09-02.md](./remediacion-marketplace-mcp-2026-09-02.md)                   | Marketplace y MCP por proyecto en 4 olas: instalar desde el panel, tools MCP que se importan solas, allowlist de MCP remotos (ADR), diferidos honestos, test que llama la tool, anclas Jira/Confluence como ajuste del proyecto.                                                                                                                                                                                                                                                                |
| [ui-reestructuracion-2026-09-09.md](./ui-reestructuracion-2026-09-09.md)                                   | Reestructuración de la UI del panel en 4 olas (+ piel opcional): el proyecto como hub con navegación propia y tablero dentro, área Sistema separada, dashboard tenant-céntrico con endpoint agregado, bandeja humana unificada, capacidades MCP/tools/skills en una pantalla, conocimiento como asistente, memorias por ámbito con procedencia. Aprobado y **arrancado** el 2026-09-09 (`in_progress`): `task_ui_04` entregada —foto de las 81 rutas y mapa de pantallas, antes de mover nada—. |
| [remediacion-instalador-runs-de-serie-2026-09-09.md](./remediacion-instalador-runs-de-serie-2026-09-09.md) | Una instalación limpia con Ollama no podía ejecutar ni un run: cuatro huecos del instalador (variables `LLM_*` que nadie leía, default `claude_sdk` hardcodeado, `base_url` sin `/v1`, sin modelo de chat con tool-calling) cerrados con TDD el 2026-09-09; espera la instalación desde cero como test humano.                                                                                                                                                                                  |
| [memoria-agentes-2026-09-09.md](./memoria-agentes-2026-09-09.md)                                           | Memoria de los agentes en 3 olas: recall por capas (índice + `memory_get`), citas por id con registro de uso, línea de tiempo, tipos de observación y resumen por ejecución, señal de utilidad en el ranking RRF con frescura y caducidad archivada, API/UI con procedencia. Análisis comparativo con claude-mem; aprobado el 2026-09-09.                                                                                                                                                       |
...
### Programa `harness-*` — profesionalización del agent harness (no entran en el gate de fases)

Seis planes con `plan_id` descriptivo, coordinados por `harness-00`, que salen de la
[auditoría del harness del 2026-09-17](./auditoria-harness-ciclo-kb-memoria-2026-09-17.md)
(verificación fichero a fichero de un borrador externo del 2026-09-16). Encadenados
entre sí por `blocking_plan`; `harness-05` además depende de `memoria-agentes-2026-09-09`.
Todos `pending_approval`; el ADR 0168 (`task_h00_01`) va antes que cualquier código.

| Fichero                                                                                                        | Qué es                                                                                                                                                                                                                                                                                                                                                                                          |
| -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [auditoria-harness-ciclo-kb-memoria-2026-09-17.md](./auditoria-harness-ciclo-kb-memoria-2026-09-17.md)         | Informe (`status: informe`). Matriz de 20 afirmaciones del borrador externo verificadas contra la rama `plan/instalador-runs-de-serie-2026-09-09`: 13 ciertas, 4 parciales (trabajo ya hecho: ADR 0135, 06.7, gov-01, `embedding_model_id`), 3 corregidas. Lista la infraestructura que el borrador daba por existente y no existe, y las tres decisiones de producto que presentaba como bugs. |
| [harness-00-programa-profesionalizacion-2026-09-17.md](./harness-00-programa-profesionalizacion-2026-09-17.md) | Programa: ADR 0168 (memoria/KB `REQUIRED`, `allowed_tools` obligatorio, guardrails fail-closed, checkpoint store, `attempt_id`), fix inmediato de `claim_id` en `as_dict()`, baseline JUnit, evidencia por tarea y E2E de aceptación.                                                                                                                                                           |
| [harness-01-contrato-run-capacidades-2026-09-17.md](./harness-01-contrato-run-capacidades-2026-09-17.md)       | `ExecutionEnvelopeV1` estricto y sellado en shared-domain, contrato de dependencias `REQUIRED/OPTIONAL/FORBIDDEN` → `dependency_report`, guardrails fail-closed sólo con política configurada, registro de capacidades observadas con probe real de tool-calling y `doctor --capabilities`, dual-read por flag.                                                                                 |
| [harness-02-checkpoints-reanudacion-2026-09-17.md](./harness-02-checkpoints-reanudacion-2026-09-17.md)         | Spike de medición primero (cuántos runs mueren a mitad); después `RemoteCheckpointSaver` de LangGraph vía API interna con token por ejecución, reanudación con presupuestos y detector, interrupts durables, checkpoint corrupto que bloquea, matriz de kill por nodo.                                                                                                                          |
| [harness-03-efectos-tool-gateway-2026-09-17.md](./harness-03-efectos-tool-gateway-2026-09-17.md)               | `ToolDescriptorV1`, `ToolResult` tipado, Tool Gateway común a tools nativas y MCP, Effect Ledger con idempotencia y reconciliación de efectos inciertos, outbox transaccional post-run, lease por attempt y matriz de crash. Reconoce que la aprobación por huella ya existe (ADR 0135).                                                                                                        |
| [harness-04-kb-reproducible-2026-09-17.md](./harness-04-kb-reproducible-2026-09-17.md)                         | Delta sobre 04 y 06.9–06.13: estados `AVAILABLE_EMPTY ≠ UNAVAILABLE` en API, runtime y preámbulo; versión de documento y `chunker_version`; `knowledge_retrieval_snapshots` y replay del bloque de contexto; fragmentos delimitados como datos; caos y cross-tenant.                                                                                                                            |
| [harness-05-memoria-gobernada-2026-09-17.md](./harness-05-memoria-gobernada-2026-09-17.md)                     | Delta sobre `memoria-agentes-2026-09-09` (seis tareas del borrador eran duplicadas): procedencia y `verification_status` en `MemoryEntry`, Memory Gate, memorización por outbox, `agent_claimed` vs `externally_verified`, estados de recall, supersesión sin reescribir, memoria envenenada.                                                                                                   |
| [harness-06-assurance-replay-caos-2026-09-17.md](./harness-06-assurance-replay-caos-2026-09-17.md)             | `traceparent` orchestrator → Celery → worker → runtime → MCP y spans GenAI; manifiesto y replay exacto/comparativo sin efectos; dry-run de evals que no sale verde y digest de comportamiento; suite común de caos; SLO; evidence gate de release; diagnóstico por `execution_id`.                                                                                                              |
...
| [auditoria-ciclo-vida-proyecto-2026-09-01.md](./auditoria-ciclo-vida-proyecto-2026-09-01.md) | El ciclo de vida de un proyecto de punta a punta (ejecución en el worker, contenedores, orquestación/review, bucle del agente, memorias, seeds/prompts, cierre de plan): 81 hallazgos, 25 críticos/altos verificados adversarialmente, 4 roturas deterministas en producción. |
...
| [2026-08-29-hallazgos-e2e-hello-world-v2.md](./2026-08-29-hallazgos-e2e-hello-world-v2.md)                                     | Diario del recorrido E2E creando un proyecto CI4 en Mediapro con el stack ya desplegado: 11 hallazgos, uno bloqueante (equipo built-in sin agentes utilizables) y uno refutado. |

## Cola de validación humana

41 planes están en `pending_human_validation`: **código mergeado en `master` sin sign-off humano**
(los dos últimos son `remediacion-marketplace-mcp-2026-09-02`, que cerró sus quince casillas el
2026-09-09 y cuyo código vive en el PR #183, aún sin mergear, y
`remediacion-instalador-runs-de-serie-2026-09-09`, cuyo test humano ES la instalación desde cero).
