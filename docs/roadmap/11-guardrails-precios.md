...
- [ ] **Título**: Code safety: análisis estático de código generado (eval, exec, rm -rf, etc.)
- **Tiempo estimado**: 8 h
- **Complejidad**: m
- **Rol sugerido**: security
...
- [ ] **Título**: Output structure (validación JSON Schema), allowed_domains, cost_ceiling, factuality/citations, topic_restriction, rate_per_agent, forbidden_actions
