...
/**
 * Secciones INTERACTIVAS del detalle de plan (hallazgo #9, refactor por partes).
 *
 * Componentes con hooks/fetch/mutations extraídos verbatim de `page.tsx` (monolito
 * de 1703 líneas): ciclo de vida, sincronizar al Kanban, desglose de coste,
 * comentarios, validación humana (app-preview), correcciones del rechazo (ADR 0107)
 * y deep-links. Cero cambio de comportamiento ni de testids. No es una ruta (nombre
