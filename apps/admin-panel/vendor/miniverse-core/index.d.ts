...
export declare class Miniverse {
    private renderer;
    private scene;
    private citizens;
    ...
    on(event: MiniverseEvent, handler: (data: unknown) => void): void;
    off(event: MiniverseEvent, handler: (data: unknown) => void): void;
    private emit;
...
export declare interface MiniverseConfig {
...
declare type MiniverseEvent = 'citizen:click' | 'object:click' | 'intercom';
