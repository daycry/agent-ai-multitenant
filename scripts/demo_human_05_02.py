...
def main() -> int:
    ...
    print("\n  -> Card del agente 'Sandbox Runner' debe listar el tool")
    print("     'alpine-probe' con:")
    print("        - badge implementation_type = docker_command  (rojo)")
    print("        - badge security_level = privileged           (rojo)")
    print("        - timeout 60s, category 'code'")
    print("\n  -> Si abres el dialog 'Editar agente' (otra fase) NO veras")
    print("     edicion de Tool rows todavia — task futura. Esta pantalla")
    print("     es read-only para diagnostico.")
